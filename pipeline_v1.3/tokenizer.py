"""
tokenizer.py — Pipeline v1.3 local copy (keep in sync with model/tokenizer.py).

Dùng khi Colab/Kaggle chỉ upload thư mục pipeline_v1.3/.
Import: from tokenizer_bootstrap import simple_tokenize, encode_text
...
Cách import trong pipeline v1.3 (notebook / script):
