"""
tokenizer.py — Pipeline  local copy (keep in sync with model/tokenizer.py).

Dùng khi Colab/Kaggle chỉ upload thư mục experiments/.
...
Cách import trong pipeline  (notebook / script):
